"""
NEW CORE CALCULATOR - Direct migration from app/calculator/contour_calculator.py.

This is the SINGLE source of truth for all mathematical logic.
Every formula, sign, angle handling, and algorithm is IDENTICAL to the original.

WARNING: Do NOT modify any mathematical expressions, signs, angle handling,
or algorithm order. The original behavior is the verified reference.
"""
import math
import json
import os
...
class ContourCalculator:
    """
    Contour geometry calculator.
    
    This is a direct migration of app/calculator/contour_calculator.py.
    All calculations are mathematically identical.
    """
