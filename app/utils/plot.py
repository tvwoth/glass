...
def generate_plot(points: List[Tuple[float, float]], output_path: str = None) -> None:
    """
    Generate and save a plot of the calculated points.
    
    Args:
        points: List of (x, y) coordinate tuples
        output_path: Path where to save the plot PNG. Defaults to "plot.png" in current directory.
    """
